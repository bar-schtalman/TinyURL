...
public class UserClickOut {
    ...
    public String calcClickTime() {
        LocalDateTime localDateTime = Dates.atLocalTime(clickTime);
        return localDateTime.toString("yyyy-MM-dd HH:mm:ss"); // Convert to String format
    }
